export const placeInfo = [
  {
    id: 1,
    headerTitle: 'The Bastard of Instanbul',
    headerSubTitle: 'by Elif Shafak',
    headerText:
      'I believe that you can learn a lot from reading an Elif Shafak book, and true to form, I learned a lot from this book',
  ...
  {
    id: 3,
    headerTitle: 'Small Memories',
    headerSubTitle: 'by Jose Saramago',
    headerText:
      'This book details his childhood in Portugal, spent back and forth between his birthplace and the capital city',
    title:
  ...
  {
    id: 4,
    headerTitle: 'A Long Petal of the Sea',
    headerSubTitle: 'by Isabel Allende',
    headerText: 'Though Isabel Allende is a well-known name amongst book lovers, I regret to say that I did not read any of her books until this one',
  ...
  {
    id: 5,
    headerTitle: 'Miss Iceland',
    headerSubTitle: 'by Auour Ava',
    headerText: 'This book follows the life of the protagonist Hekla. She valiantly tries to be a writer in a world which refuses to consider her as anything other than an object of beauty',
  ...
  {
    id: 6,
    headerTitle: 'Purple Hibiscus',
    headerSubTitle: 'by Chimamanda Ngozi Adichie',
    headerText:
      'This book was my first Adichie but certainly was not my last. After reading this book, I went down the google rabbit hole to learn more about the various foods, clothes, cultures, traditions, and places mentioned in it',
    title: 'Animi nobis',
    description:
